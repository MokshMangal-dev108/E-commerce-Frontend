      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
            ...
            <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                ...
                <h1 className="text-lg lg:text-xl font-semifold text-gray-900">
                  {" "}
                ...
                <form className="mt-10">
                    ...
                    <Button onClick={handleAddToCart} variant="contained" sx={{p:"2rem",py:"1rem",bgcolor:"#9155fd"}}>
                      Add To Cart
                    </Button>
                </form>
                </div>
                    ...
                    <Grid item xs={5}>
                          ...
                          <Box className="mt-5 space-y-3">
                            ...
                            <Grid container alignItems="center" gap={2}>
                              ...
                              <Grid item xs={7}>
                                <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant="determinate" value={15} color="error"></LinearProgress>
                              </Grid>
                            </Grid>
